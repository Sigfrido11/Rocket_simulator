...
void create_ad_eng_all(ad_eng_data &eng_data) {
  ...
  std::cout << "give me the temperature of the engine (K) 2'500 < x < 3'800"
            << '\n';
  std::cin >> eng_data.t_0;
  std::cout << "give me the dimension of the grain for the engine (m) ≈0.02"
            << '\n';
  std::cin >> eng_data.grain_dim;
  std::cout << "give me the density of the grain for the engine (kg/m^3) ≈2800"
            << '\n';
...
rocket_data create_complete_roc() {
  ...
  std::cout << "what's the mass of the container of each stadium (kg) ≈ 15'000"
            << "\n";
...
rocket_data create_med_roc() {
  ...
  std::cin >> rocket_data.stage_num;
  std::cout
      << "what's the mass of the propellant of each stadium (kg) ≈ 100'000"
      << "\n";
  std::cin >> rocket_data.stage_num;
  std::cout << "how many engines does the solid propellant have: < 3 "
            << "\n";
  std::cin >> rocket_data.n_solid_eng;
  return rocket_data;
}
...
void create_base_eng_all(base_eng_data &eng_data) {
  ...
  std::cout << "give me the coefficient of losing mass (kg/s) 1.5 < x < 4. "
            << '\n';
  std::cin >> eng_data.cm;
